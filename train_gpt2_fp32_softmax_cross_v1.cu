...
double softmax_cross_kernel_time_elapsed_s = (end.tv_sec - start.tv_sec) + (end.tv_nsec - start.tv_nsec) / 1e9;
printf("softmax_cross_kernel_time_elapsed_s : %f \n", softmax_cross_kernel_time_elapsed_s * 1000);
#endif
